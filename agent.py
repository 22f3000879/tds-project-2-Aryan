...
def analyze_task(decoded_html: str):
    ...
    - "question": The ACTUAL problem to solve (e.g. "What is the sum of...", "Count the rows..."). Do NOT extract the text that says "Post your answer to". Capture the data processing task itself.
...
def solve_question(question: str, file_summary: str):
    ...
    INSTRUCTION:
    - If the question asks for a number, return just the number (integer or float).
    - If the question asks for text, return the text.
